                    ...
                    <div className="card-body p-0">
                        <div className="table-responsive active-projects shorting">
                            <div className="tbl-caption">
                                <h4 className="heading mb-0">Leads Report</h4>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div className="products">
                                                <img src="images/avatar.png" className="avatar avatar-md rounded-circle" alt="" />
                                                <div>
                                        ...
                                        <td className="pe-0">
                                            <div className="tbl-progress-box">
                                                <div className="progress">
                                                    <div className="progress-bar bg-primary" style={{ width: '53%', height: '5px', borderRadius: '4px' }} role="progressbar" />
                                                </div>
