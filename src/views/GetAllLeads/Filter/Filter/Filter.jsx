...
function Filter(props) {
    ...
    props?.propsData(responseData, filterState, setFilterState);
                            ...
                            <Formik enableReinitialize="true" initialValues={initialValues} onSubmit={onSubmit}>
                                <Form>
                                    <div className="row">
                                        ...
                                        <div className="col-xl-2 mb-3">
                                            <button type="submit" onClick={handleClick} className="btn btn-primary" style={{ marginBottom: '-72px' }}>
