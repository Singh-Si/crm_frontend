...
function ImportLead() {
    ...
    const handleFileUpload = async () => {
        ...
        const file = Array.from(file).filter(file => allowedFileTypes.includes(file.type));
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="row">
                                ...
                                <button className="btn btn-primary grp-btn"><i class="fa-solid fa-upload me-2" onClick={handleFileUpload}></i>Upload</button>
                                </div>
                            </div>
                            </form>
                        </div>
